...
<template>
    <div class="container mx-auto lg:px-8 space-y-4 px-4 py-16">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="stix text-[38px]">Решения для вашего бизнеса</h1>
                <p class="text-cgray">У нас есть все необходимые ресурсы для решения любых ваших потребностей в сфере
                    интеллектуальной собственности</p>
            </div>
            <button class="hidden md:block animate-arrow-btn-right border border-cred text-cred px-6 py-2 rounded-[50%] relative">Все услуги
